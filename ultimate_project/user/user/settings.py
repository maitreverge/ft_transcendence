...
DATABASES = {
    'default': {
        ...
        'HOST': os.getenv('USER_POSTGRES_HOST'), # Hostname where the database server is running == compose service == Name of the db
        'PORT': os.getenv('USER_POSTGRES_PORT'), # Port number on which the database server is listening.
    }
}
